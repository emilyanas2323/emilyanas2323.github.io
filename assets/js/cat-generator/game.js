...
const catImages = ["/assets/images/cat-generator/catImage.png", "/assets/images/cat-generator/catImage1.png", "/assets/images/cat-generator/catImage2.png", "/assets/images/cat-generator/catImage3.png"];
catImage.src = catImages[0];

var backgroundImage = new Image();
const backgroundImages = ["/assets/images/cat-generator/space.png", "/assets/images/cat-generator/sky.png", "/assets/images/cat-generator/city.jpg", "/assets/images/cat-generator/snowy.png"];
backgroundImage.src = backgroundImages[0];

var catWidth = catImage.naturalWidth/6;
var catHeight = catImage.naturalHeight/6;
...
cat.prototype.update = function () {
	...
	if( this.x <= 0 || this.x+this.width*1.2 >= game.gameFieldHeight()) {
        this.xDir *= -1;
		while(this.x <= 0 || this.x+this.width*1.2 >= game.gameFieldHeight()) {
			this.x += this.xDir;
		}
    }
};
...
var game = (function () {
    ...
    function _start() {
        _entities.push(new cat(Math.floor(Math.random() * (_gameFieldHeight - catWidth)), Math.floor(Math.random() * (_gameFieldHeight - catHeight)),1,1));
	...
	spawn.addEventListener('click', () => {
		if(_entities.length < 10){
			...
			do {
				collision = false;
				var randomX = Math.floor(Math.random() * (_gameFieldHeight - catWidth));
